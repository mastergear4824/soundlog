...
> [!WARNING]
> **이 앱의 사용은 [YouTube 서비스 약관](https://www.youtube.com/t/terms)에 위배될 수 있습니다.** 저작권이 있는 콘텐츠의 다운로드·복제는 법적 책임을 수반할 수 있습니다. 이 소프트웨어는 **개인적·비상업적·교육 목적**으로만 제공되며, 사용에 따른 모든 책임은 **사용자 본인**에게 있습니다.
