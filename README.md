...
스트리밍 서비스의 URL을 붙여넣으면 오디오를 추출해 **태그·커버 아트가 입혀진 MP3**로 로컬에 저장하고, 저장한 곡을 앱 안에서 바로 재생하는 네이티브 macOS 앱.

> 창이 곧 로그(log)다 — 저장한 음악이 한눈에 쌓이고, 같은 항목은 다시 받지 않습니다.

> [!WARNING]
> **이용하는 스트리밍 서비스의 이용약관을 반드시 확인하세요.** 콘텐츠 저장·복제가 해당 서비스의 약관에 위배되거나 저작권 관련 법적 책임을 수반할 수 있습니다. 이 소프트웨어는 **개인적·비상업적·교육 목적**으로만 제공되며, 사용에 따른 모든 책임은 **사용자 본인**에게 있습니다.
...
- **자가 치유**: 서비스 변경으로 추출이 막히면 대체 클라이언트로 자동 재시도, yt-dlp 업데이트 안내
...
개인 학습·소장 용도의 도구입니다. 콘텐츠 저장은 이용하는 스트리밍 서비스의 약관 및 저작권의 적용을 받으니 반드시 확인하세요. 사용에 대한 모든 책임은 사용자 본인에게 있습니다.
